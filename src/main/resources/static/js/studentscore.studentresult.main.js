$(function () {
    ...
    $("select[name=Clno]").change(function() {
    	...
    	location.replace("./index?clno=" + clno);
    });
    // 定义课程信息数组
    var courses = null;
    // 获取课程信息，存储到数组
    ...
    $("select[name=Cono]").change(function() {
    	...
    	location.replace("./index?cono=" + cono);
    });
                    ...
                    <tr class="table-borderless">\
                        <td colspan="4">\
                            <nav aria-label="Page navigation example">\
                                <ul class="pagination">\
                                    <li class="page-item"><a class="page-link" href="./index?q=' + q + '&page=1">首页</a></li>\
                                    <li class="page-item"><a class="page-link" href="./index?q=' + q + '&page=' + lastpage + '">上一页</a></li>\
                                    <li class="page-item"><a class="page-link" href="./index?q=' + q + '&page=' + nextpage + '">下一页</a></li>\
                                    <li class="page-item"><a class="page-link" href="./index?q=' + q + '&page=' + pagenum + '">尾页</a></li>\
                                </ul>\
                            </nav>\
                        </td>\
                        <td colspan="5">\
                ...
                tbody.append('\
                    ...
                    <tr class="table-borderless">\
                        <td colspan="4">\
                            <nav aria-label="Page navigation example">\
                                <ul class="pagination">\
                                    <li class="page-item"><a class="page-link" href="./index?clno=' + qclno + '&page=1">首页</a></li>\
                                    <li class="page-item"><a class="page-link" href="./index?clno=' + qclno + '&page=' + lastpage + '">上一页</a></li>\
                                    <li class="page-item"><a class="page-link" href="./index?clno=' + qclno + '&page=' + nextpage + '">下一页</a></li>\
                                    <li class="page-item"><a class="page-link" href="./index?clno=' + qclno + '&page=' + pagenum + '">尾页</a></li>\
                                </ul>\
                            </nav>\
                        </td>\
                        <td colspan="5">\
                ...
                tbody.append('\
                    ...
                    <tr class="table-borderless">\
                        <td colspan="4">\
                            <nav aria-label="Page navigation example">\
                                <ul class="pagination">\
                                    <li class="page-item"><a class="page-link" href="./index?cono=' + qcono + '&page=1">首页</a></li>\
                                    <li class="page-item"><a class="page-link" href="./index?cono=' + qcono + '&page=' + lastpage + '">上一页</a></li>\
                                    <li class="page-item"><a class="page-link" href="./index?cono=' + qcono + '&page=' + nextpage + '">下一页</a></li>\
                                    <li class="page-item"><a class="page-link" href="./index?cono=' + qcono + '&page=' + pagenum + '">尾页</a></li>\
                                </ul>\
                            </nav>\
                        </td>\
                        <td colspan="5">\
